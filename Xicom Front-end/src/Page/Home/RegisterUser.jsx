  ...
  const handleSubmit = async () => {
    try {
      ...
      if (err?.inner) {
        ...
        const docErrors = err.inner.filter(error => error.path === 'documents');
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:outline-none transition duration-200"
            />
            <small className="text-gray-500 text-xs">Minimum age should be 18 years</small>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label htmlFor="resStreet1" className="block text-sm font-medium text-gray-700">
            ...
            <div className="space-y-2">
              <label htmlFor="resStreet2" className="block text-sm font-medium text-gray-700">
        ...
        {!isSameAddress && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="permStreet1" className="block text-sm font-medium text-gray-700">
                  Street 1 <span className="text-red-500 ml-1">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <label htmlFor="permStreet2" className="block text-sm font-medium text-gray-700">
                  Street 2 <span className="text-red-500 ml-1">*</span>
                </label>
                <input
                  type="text"
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Minimum 2 documents are required</p>
          </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <small className="text-gray-500 text-xs block mt-1">Supported: Image, PDF</small>
                ...
                {/* Upload Document */}
                <div className="space-y-2">
                  <label htmlFor={`file-${doc.id}`} className="block text-sm font-medium text-gray-700">
                  ...
                  <div className="relative">
                    ...
                    />
                    <div className="border-2 border-dashed border-gray-300 hover:border-blue-400 transition duration-200 p-4 rounded-lg w-full flex items-center justify-center bg-white min-h-[60px] focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200">
                      <div className="text-center pointer-events-none">
                        <LuUpload className="mx-auto h-5 w-5 text-gray-400 mb-1" />
                ...
                <div className="flex items-end justify-center pb-1">
                  {index === 0 ? (
                    <button
                      ...
                      className="bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition duration-200 flex items-center justify-center w-12 h-12 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-300"
                      title="Add Document"
                    >
        ...
        <div className="flex justify-center pt-6">
          {isLoading ? (
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-200 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
              Submit Registration
            </button>
          )}
